...
public class DirectoryWatcher {
    ...
    public struct Configuration {
        ...
        /// When enabled, directory-level events trigger a snapshot of the
        /// changed directory so `onFilteredChange` can report matching files.
        /// Disable this for workloads that consume exact file-level events and
        /// must avoid directory listing work on large trees.
    ...
    private func handleFileSystemEvent() {
        debouncer.debounce { [weak self] in
            ...
            let filteredFiles =
                self.configuration.scansChangedDirectoriesForFilteredEvents
